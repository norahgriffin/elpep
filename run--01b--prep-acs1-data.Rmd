...
acs1_hoh <- 
  ...
  select(YEAR, SAMPLE, SERIALNO, hoh_educ, hoh_industry, hoh_industry_vulnerable, hoh_race, hoh_hispanic)
```
...
acs1_child <- 
  ...
  .[, `:=`(child_agegroup = bin_age(AGEP),
           ...
           fam_incpov_ratio_cat_mix   = bin_incpov_ratio(fam_incpov_ratio, pov_breaks = c(0, 0.5, 1.0, 2.0, 3.0)),
