...
crosswalk <- 
  read_nhgis(glue("{input_path}nhgis_bg2010_tr2020_{my_state_fip}.csv")) %>% 
...
tr_xwalk$GEOID_TRACT_20 = str_pad(tr_xwalk$GEOID_TRACT_20, 11, pad = "0")
```
