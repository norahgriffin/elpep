...
# CCDF threshold is 225 FPL, the SAE estimates `work_incpov_stats75 %in% 
# c("WorkElig_0%-75%", "WorkElig_75%-150%", "WorkElig_150%-225%")` could be
# added to make a direct comparison.

work_incpov_spec_field <- 
  case_when(local_ccdf_thresh == 200 ~ "work_incpov_status100",
...
if (rerun_sae) {
  ...
  if (parallelize_sae) {
    ...
    sae_results_ccdf_wk_pov_12       <- run_sae_combos_bycontrols(work_incpov_spec_field, acs1_child612_sae, sae_controls_added_2534)
  }
