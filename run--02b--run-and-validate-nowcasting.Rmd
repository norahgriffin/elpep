...
cps_child_base_post <- 
  ...
  mutate(
         ...
         # methods
         share_0_80    = 1*(fam_incpov_ratio_cat_byMix  ==   "0%-80%"),
         share_80_100  = 1*(fam_incpov_ratio_cat_byMix  ==  "80%-100%"),
...
transition_pred_vars_toadd_pov      <- 
  c("share_0_80", "share_80_100", "share_100_200", "share_200_300", "share_300")
...
acs5_keep_vars <- 
  unique(c("GEOID", "COUNTYFIP",
           ...
           "age_13to17_count", "age_13to17_se", 
           transition_pred_vars_acs5,
...
pop_for_nowcast <- 
  ...
  mutate(age_0to5_se  = 0,
         age_6to12_se = 0,
         age_13to17_se = 0) %>% 
  select(GEOID, age_0to5_count, age_0to5_se, age_6to12_count, age_6to12_se, age_13to17_count, age_13to17_se)
```
